...
@app.route("/")
@app.route("/<name>")
def home(cputemp=None, result=None, videoinLocalSize=None, videoinUsbSize=None):
    ...
    return render_template('home.html', cputemp=get_cpu_temp, result=result, videoinLocalSize=videoinLocalSize, videoinUsbSize=videoinUsbSize)
